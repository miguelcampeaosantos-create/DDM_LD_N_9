...
export default function TarefasGestor() {
  ...
  return (
    <div style={{ background: "#1f1f1f", minHeight: "100vh", padding: 30, color: "white" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ color: "white" }}>Tarefas — Gestor</h1>

        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={fetchTarefas}>Atualizar</button>
          <button onClick={() => window.location.href = "/gestor/criar-tarefa"}>Criar Tarefa</button>
          <button onClick={() => window.location.href="http://localhost:3000/relatorios/exportar-csv"}>
          Exportar CSV
          </button>
      ...
      <div style={{
        ...
        {[
          ...
          >
            ...
            {tarefas.filter(t => t.estado === col).map(t => (
              <div
                key={t.id}
                style={{
                  background: "#ffffff",
